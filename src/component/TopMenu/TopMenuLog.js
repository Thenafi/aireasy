<Nav
      ...
      >
        ...
        <Nav.Link href="#" onClick={()=> setClicklogin(true)} className="m-1 p-2 Button_1" style={{color: '#fff'}}>Log In</Nav.Link>
        ...
        <Nav.Link href="#" onClick={()=> setClickFilter(true)} className="m-1 p-2 Button_1" style={{color: '#fff'}}>Filter</Nav.Link>
