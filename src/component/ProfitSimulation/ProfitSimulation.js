...
function ProfitSimulation() {
  const { allCalculation , annualExpenses,
    startupCost, cashReturn, netRentalYield,
    annualRevenue, profitBeforeTax, data} = useSimulationContext();
    ...
    <>
        <Col lg={12}>
            <Card border="light" className="m-1 rounded displayCard_1">
                <Card.Body>
                    <Card.Title style={{alignText: 'center'}}>Profit Simulation</Card.Title>
                    <Card.Text>
                        <Row>
                            <Col md={6}>
                        ...
                        <Row>
                            ...
                            <Form.Label className="label">Startup Cost</Form.Label>
                              ...
                              <Col md={6}>
                              <a href="#" onClick={()=> setClick(true)} className="p-2 btn btn-dark mt-3" style={{color: '#fff'}}>Edit Details</a>
                              </Col>
...
{/* signup modal */}
                  ...
                  <Modal.Body>
                    <Form className="py-5 px-2" onSubmit={sub}>
                      ...
                      <Row>
                        ...
                        <Form.Label className="label" style={{fontSize: "0.9rem"}}>Management Fee</Form.Label>
                          <Form.Control
                         type="number"
                          name="managementFee"
                        ...
                        <Form.Label className="label">Property Tax</Form.Label>
                          <Form.Control
                            type="number"
                          name="propertyTax"
                          onChange={inputHandle}
                      ...
                      <Row style={{marginTop:'-1rem'}}>
                        ...
                        <Form.Label className="label">Lodgning Tax</Form.Label>
                          <Form.Control
                            type="number"
                          name="lodgningTax"
                          onChange={inputHandle}
                        ...
                        <Form.Label className="label">Mortgage Fee</Form.Label>
                      ...
                      <Row style={{marginTop:'-1rem'}}>
                        ...
                        <Form.Label className="label">Maintenance</Form.Label>
                          <Form.Control type="number"
                           name="maintenance"
                           onChange={inputHandle}
                      ...
                      <Row style={{marginTop:'-1rem'}}>
                        ...
                        <Form.Label className="label">Electricity</Form.Label>
                          <Form.Control type="number"
                          name="electricity"
                          onChange={inputHandle}
                      ...
                      <Row style={{marginTop:'-1rem'}}>
                        ...
                        <Form.Label className="label">Occupancy Rate</Form.Label>
                          <Form.Control
                        type="number"
                          name="occupancyRate"
                           onChange={inputHandle}
                        ...
                        <Form.Label className="label">Nightly Rate</Form.Label>
                          <Form.Control type="number"
                          name="nightlyRate"
                          onChange={inputHandle}
                      ...
                      <Row style={{marginTop:'-1rem'}}>
                        ...
                        <Form.Label className="label">Cleaning Fee</Form.Label>
                          <Form.Control type="number"
                          name="cleaningFees"
                          onChange={inputHandle}
                        ...
                        <Form.Label className="label"> Bookings Per Month</Form.Label>
                          <Form.Control type="number"
                      ...
                      <h3 className="text-dark text-center text-bolder py-2">Startup Cost and Property Price</h3>
                      <Row style={{marginTop:'-1rem'}}>
                        <Form.Group className="mb-3 m-2 col-5 mx-auto" controlId="HomeFurnishing">
                        <Form.Label className="label">Home Furnishing</Form.Label>
                        <Form.Control type="number"
                        ...
                        <Form.Label className="label">Closing Cost</Form.Label>
                          <Form.Control type="number"
                           name="closingCost"
                           onChange={inputHandle}
                        ...
                        <Form.Group className="mb-3 m-2 col-5 mx-auto" controlId="PropertyPrice">
                        <Form.Label className="label">Property Price</Form.Label>
                          <Form.Control type="number"
                           name="propertyPrice"
                           onChange={inputHandle}
                      ...
                      <Button variant="primary" className="m-1 col-4 ms-4 Button" type="submit" onClick={()=> setClick(false)}>  Submit </Button>
                ...
                <Card.Footer>
                    <p className="">Cash Return: <b>${cashReturn}%</b></p>
                    <p className="">Profit Before Tax: <b>${ profitBeforeTax}</b></p>
                    <p className="">Net Return Yied: <b>{netRentalYield}%</b></p>
